...
RUN echo $TZ > /etc/timezone \
 ...
 && apt-get update \
 && apt-get upgrade -y \
 && apt-get install -y --no-install-recommends locales acl libcurl4-gnutls-dev ntp htop python3-pip ipython3 nginx \
...
# Variáveis de ambiente que configuram o watcher "chokidar"
# do node.js, para evitar problemas com o docker em hosts windows
